...
let btn_calcular = document.getElementById("enter")
btn_calcular.addEventListener("click", atualizarValor)

litros.addEventListener("keydown", function(event){
    event.preventDefault() // evita que o formulário seja executado
    atualizarValor()
})
